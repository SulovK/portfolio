...
I enjoy taking messy operational problems, finding the story in the data, and turning the results into something people can actually use. My current interests include decision modeling, process improvement, reporting, and practical applications of analytics in day-to-day operations.

## Core toolkit

| Analytics & programming | Business intelligence | Data & productivity |
| --- | --- | --- |
| Python · R · SQL | Tableau · Power BI | Excel · Power Query |
| Statistical analysis | Data visualization | Pivot tables |
| Optimization modeling | Reporting & dashboards | Jupyter · R Markdown |

**Databases:** MySQL · Oracle · Microsoft Access  
**Tools:** Git · GitHub · Salesforce · Microsoft Project · Microsoft Planner
...
Alongside my academic projects, I’ve worked as a programmer analyst, graduate assistant, resident assistant, international student ambassador, and database assistant. These experiences strengthened my ability to communicate with different audiences, manage competing priorities, and design solutions around the people who use them.
